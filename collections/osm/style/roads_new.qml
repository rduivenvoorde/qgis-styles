...
<qgis version="2.17.0-Master" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="1" type="RuleRenderer" enableorderby="0">
    <rules key="{2b30c815-7d41-45b0-84a7-3bae019d7788}">
      <rule checkstate="0" filter="type IN ( 'motorway') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{44bd051e-66e5-40ea-9e6d-d5f9559b0963}" symbol="0" label="motorway bridges"/>
      <rule checkstate="0" filter="type IN ( 'motorway') " key="{22a08244-2090-427d-aa23-fc1b140346f8}" symbol="1" label="motorway"/>
      <rule checkstate="0" filter="type IN('trunk', 'motorway_link', 'trunk_link') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{a2b0c79c-2f82-488d-adec-3f55c5a3f623}" symbol="2" label="trunk bridges"/>
      <rule checkstate="0" filter="type IN('trunk', 'motorway_link', 'trunk_link')" key="{f00ec72e-09fc-48c5-89b3-eb6a3d0e6f31}" symbol="3" label="trunk"/>
      <rule checkstate="0" filter="type IN ('primary','primary_link')  AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{dd3717c9-c699-4401-8ece-9f3f27930b0c}" symbol="4" label="primary bridges"/>
      <rule filter="type IN ('primary','primary_link')" key="{ea3c8bc9-20d2-4f27-bd8c-11bf2bf3e196}" symbol="5" label="primary "/>
      <rule checkstate="0" filter="type IN ('secondary','secondary_link') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{ddefd96a-9333-45da-a073-42c14ccaf8b1}" symbol="6" label="secondary bridges"/>
      <rule checkstate="0" filter="type IN ('secondary','secondary_link')" key="{f499e0ad-f64d-4457-a513-01077cc2dde7}" symbol="7" label="secondary"/>
      <rule checkstate="0" filter="type IN ('tertiary', 'tertiary_link') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{fce95398-1622-450b-a972-ca40089b5a28}" symbol="8" label="tertiary bridges"/>
      <rule checkstate="0" filter="type IN ('tertiary', 'tertiary_link')" key="{f0b23577-4614-4b12-9aa6-3fc9d561a9d0}" symbol="9" label="tertiary "/>
      <rule checkstate="0" filter="type IN ( 'road', 'living_street', 'residential', 'unclassified', 'pedestrian')  AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{749ddf66-e2b0-4fc7-9f97-4ee93c5f47a1}" symbol="10" label="road bridges"/>
      <rule checkstate="0" filter="type IN ( 'road', 'living_street', 'residential', 'unclassified', 'pedestrian')" key="{14be58f8-52ff-4294-bd6d-f88e1b4178bd}" symbol="11" label="road "/>
      <rule checkstate="0" filter="type IN ( 'service')  AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{586628f9-3667-4e4c-a97c-f67bef4fc3a6}" symbol="12" label="service roads bridges"/>
      <rule checkstate="0" filter="type IN ( 'service')" key="{252aa68f-0251-41f4-bfef-14d7ce8d59f5}" symbol="13" label="service roads"/>
      <rule checkstate="0" filter="type = 'cycleway'  AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{7900ab89-b7a7-4ee6-8d7d-fb09be85a429}" symbol="14" label="cycleway bridges"/>
      <rule checkstate="0" filter="type = 'cycleway'" key="{658dc367-5318-4cf0-b5aa-a718a4391376}" symbol="15" label="cycleway"/>
      <rule checkstate="0" filter="type IN ('track') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{e066e353-b9c4-46bb-ab18-06018d4865cf}" symbol="16" label="track bridges"/>
      <rule checkstate="0" filter="type IN ('track')" key="{f9cc3a9f-ffb4-40f5-bad8-8fda6a483217}" symbol="17" label="track"/>
      <rule checkstate="0" filter="type IN ('path', 'footway') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{2d6f9f67-3071-4730-ad55-16884cf97413}" symbol="18" label="path bridges"/>
      <rule checkstate="0" filter="type IN ('path', 'footway')" key="{dec23877-c1e5-40f7-88bf-7a4010eb4b4b}" symbol="19" label="path"/>
    </rules>
    <symbols>
